...
const int relayPinList[numberOfRelays] = {23, 22, 5, 4, 7, 6, 9, 8, 11, 10, 14, 12, 18, 15, 2, 19};
...
class SSRController {
  ...
  private:
    ...
    void setDutyCycle(float percentage)
    {
      ...
      sprintf(print_buf, "Manually setting duty cycle inside setdutycycle to %f", duty_cycle);
        Serial.println(print_buf);
        Serial.println(_pin);
